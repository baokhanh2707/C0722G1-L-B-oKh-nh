			...
			907: function (t, e) {
				...
				var n = new Map([
						...
						[
							...
							{
								api:
									"https://api.github.com/repos/mathjax/mathjax/releases/latest",
								key: "tag_name",
								base:
									"https://rawcdn.githack.com/mathjax/MathJax/"
							}
						],
						[
							"gitcdn.xyz",
						...
						[
							"cdn.statically.io",
							{
								...
								key: "tag_name",
								base:
									"https://cdn.statically.io/gh/mathjax/MathJax/"
							}
						],
						[
							"unpkg.com",
					...
					o = {
						api:
							"https://api.github.com/repos/mathjax/mathjax/releases",
						key: "tag_name"
					},
				...
				function s(t) {
					console &&
						console.error &&
						console.error("MathJax(latest.js): " + t);
				}
				...
				function l(t, e) {
					...
					"" === a &&
						...
						(r = r.replace(/\?$/, "") + "?" + a));
					var n = (r.match(
							/(\d+\.\d+\.\d+)(\/es\d+)?\/latest.js\?/
						) || ["", ""])[1],
						o =
							(r.match(/(\/es\d+)\/latest.js\?/) || [
								"",
								""
							])[1] || "";
					return {
				...
				function d(t, e) {
					...
					a
						? a.appendChild(r)
						: s("Can't find the document <head> element");
				}
